          ...
          <View style={{ flexDirection: "row", gap: Spacing.sm }}>
            ...
            >
              <ThemedText
                ...
                bold
                style={{
                  color: !selectedLevel ? "#fff" : colors.textSecondary,
                }}
              >
                All
              </ThemedText>
            ...
            {levels.map((l) => (
              <PressScale
                ...
                style={[
                  ...
                  {
                    backgroundColor:
                      selectedLevel === l ? colors.primary : colors.surface,
                  },
                  selectedLevel === l
                    ? {}
                    : { borderWidth: 1, borderColor: colors.border },
              ...
              >
                <ThemedText
                  ...
                  bold
                  style={{
                    color: selectedLevel === l ? "#fff" : colors.textSecondary,
                  }}
                >
                  {l}
                </ThemedText>
                    ...
                    >
                      {c.average_rating ? (
                        <>
                          ...
                          <ThemedText
                            variant="caption"
                            style={{ color: colors.warning, marginLeft: 2 }}
                          >
