export const Colors: Record<ColorScheme, {
  background: string; surface: string; surfaceSecondary: string; surfaceTertiary: string;
  primary: string; primaryHover: string; primaryLight: string; primaryMedium: string;
  ...
  notificationBadge: string; skeleton: string; cardShadow: string; overlay: string; tabInactive: string;
  tabBarBorder: string;
}> = {
  light: {
    background: '#EEF2FF',
